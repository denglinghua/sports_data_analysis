...
def __run_pace_group_set():
    ...
    group_set = __range_group_set(title, col, group_by, __filter_running_func)
...
def __run_distance_group_set():
    ...
    group_set = __range_group_set(title, col, RangeGroupBy(5, 100, 5), __filter_running_func)
...
def __swimming_distance_group_set():
    ...
    group_set = __range_group_set(title, col, RangeGroupBy(500, 5000, 500), __filter_swimming_func)
    group_set.xtitle = lang.m
    return group_set
...
def __cycling_distance_group_set():
    ...
    group_set = __range_group_set(title, col, RangeGroupBy(20, 100, 20), __filter_cycling_func)
    group_set.xtitle = lang.km
    return group_set
...
def __activity_time_group_set():
    ...
    group_set = __range_group_set(title, col, RangeGroupBy(30, 180, 30))
